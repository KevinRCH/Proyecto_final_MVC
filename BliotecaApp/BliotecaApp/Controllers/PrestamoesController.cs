...
namespace BliotecaApp.Controllers
{
    public class PrestamoesController : Controller
    {
        ...
        public PrestamoesController(DbBibliotecaContext context)
        {
            _context = context;
        }
        ...
        {
            var dbBibliotecaContext = _context.Prestamos.Include(p => p.Cliente);
        ...
        public async Task<IActionResult> Create([Bind("PrestamoId,FechaSalida,FechaDevolucion,ClienteId,PrestamoLibro")] Prestamo prestamo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PrestamoId,FechaSalida,FechaDevolucion,ClienteId,PrestamoLibro")] Prestamo prestamo)
        {
